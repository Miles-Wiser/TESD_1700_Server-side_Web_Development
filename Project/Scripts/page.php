...
class Page {
    ...
    public function DisplayHead() {
        ...
        <head>
            <meta lang="en">
            <meta charset="UTF-8">
            <meta name="description" content="Dave's Music Store will help you find all major music brand instruments, equipment, and scores.">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title><?=$this->title?></title>
            <link href="CSS/reset.css" rel="stylesheet">
            <link href="CSS/layout.css" rel="stylesheet">
            <link href="CSS/<?=$this->moreCSS?>" rel="stylesheet">
            <script src="Scripts/cart.js" defer></script>
        </head>
        <body>
            <header>
                <div class="header-logo">
                    <img src="Images/daves-music-store-logo.png" alt="Dave's Music Store Logo">
